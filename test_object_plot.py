# -*- coding: utf-8 -*-
"""
Created on Thu Nov 15 19:48:30 2018
...
class cPlot(object):
    ...
    def __init__(self):
        ...
        self.axpre = plt.axes([0.82, 0.91, 0.045, 0.045])
        self.axpost = plt.axes([0.88, 0.91, 0.045, 0.045])
        self.axpower = plt.axes([0.94, 0.91, 0.045, 0.045])
    ...
    def ax2setup(self):
        ...
        self.ax2 = plt.subplot2grid((30,31),(4, 17), colspan=13, rowspan=16)
    ...
    def timeSeries(self, event):
        ...
        if cp.plot_vers == 2:  # maybe just: if cp.plot_vers != 2:
            ...
            self.ax3 = plt.subplot2grid((30,31),(21, 1), colspan=29, rowspan=8)
    ...
    def powerMap(self, event):
        ...
        if cp.plot_vers != 3:
            ...
            self.slid_freqs = Slider(axslider2, 'Period', (1./freqs[-1])/60., 50., valinit=4., valfmt='%0.2f')
...
class functions():  
    ...
    def hist(self):
        ...
        cp.ax2.hist(pNaN, bins=25, edgecolor='black', alpha=0.75)  # need a set_data
